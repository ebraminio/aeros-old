...
QEMUFLAGS = -vga std -monitor stdio -serial tcp:127.0.0.1:1234,server,nodelay -net dump,file=netdump.pcap -net nic,model=e1000 -net user,hostfwd=tcp::5555-:5555
